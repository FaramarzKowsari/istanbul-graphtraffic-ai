...
This manuscript is a first full scientific draft derived from the preregistered Protocol v2, public confirmatory archive, and registered results. Before preprint submission, the following publication-production tasks remain:

1. final literature audit against work available at submission time;
2. journal/preprint-specific reference formatting;
3. preparation of publication-quality figures;
4. final language and statistical consistency check;
5. creation of a searchable PDF;
6. insertion of the final preprint DOI/URL after deposit.
