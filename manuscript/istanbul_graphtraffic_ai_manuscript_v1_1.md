...
Manuscript v1.1 integrates four publication figures and their journal-style captions while preserving the preregistered methods and confirmatory interpretation.
...
3. final language and statistical consistency check;
4. creation and inspection of a searchable publication PDF;
5. insertion of the final preprint DOI/URL after deposit.
